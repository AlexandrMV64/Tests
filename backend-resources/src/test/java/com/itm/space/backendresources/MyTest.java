...
@WithMockUser(username = "aleksandr", password = "test", authorities = "ROLE_MODERATOR")
public class MyTest extends BaseIntegrationTest {
    ...
    void initNecessaryMocks() {
        testUserRequest = new UserRequest("alex", "alexMV@gmail.com", "qwerty", "Aleksandr", "Myasnikov");
        testInvalidUserRequest = new UserRequest("alex", "@gmail.com", "", "Aleksandr", "");
    ...
    public void helloControllerTest() {
        ...
        assertEquals("aleksandr", mockHttpServletResponse.getContentAsString());
    }
